...
DATA_PATH="$HOME/workspace/LLM-Adapters/ft-training_set/commonsense_170k.json"
...
MODEL_NAME_OR_PATH=${5:-"meta-llama/Llama-2-13b-hf"}
...
OUTPUT=${EXPERIMENT_DIR}/results/comm/train/${OUTPUT}
mkdir -p "$OUTPUT"
